...
def scan_directions():
    ...
    # Mål den retning vi allerede peger i
    time.sleep(SCAN_SETTLE)

    clearance, _, _ = read_front()
    clearances[heading] = clearance

    # Drej rundt og mål de tre andre retninger
    for _ in range(3):
...
# --------------------------------------------------
# Kør et lille stykke i valgt retning
# --------------------------------------------------
...
# --------------------------------------------------
# Har vi fundet den originale rute igen?
# --------------------------------------------------
